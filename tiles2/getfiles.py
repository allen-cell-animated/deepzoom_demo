...
dest_dir = './src/'
imgpath = '//allen/aics/animated-cell/Allen-Cell-Explorer/Allen-Cell-Explorer_2_test/Cell-Viewer_Thumbnails/'
...
for dirpath, dirnames, filenames in os.walk(dest_dir):
    for filename in [f for f in filenames]:
        newname = str(random.randint(0,999999)).zfill(6) + filename
